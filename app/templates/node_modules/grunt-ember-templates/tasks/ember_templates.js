...
module.exports = function(grunt) {
  ...
  // filename conversion for compile-templates
  ...
  grunt.registerMultiTask('emberTemplates', 'Compile Handlebars compile-templates for Ember.', emberTemplatesTask);

  // TODO: remove deprecated `ember_templates` task from v0.5
  grunt.registerMultiTask('ember_templates', 'Compile Handlebars compile-templates for Ember. [DEPRECATED: please use `emberTemplates` instead]', function() {
