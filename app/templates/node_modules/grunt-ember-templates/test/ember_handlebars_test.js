...
exports.handlebars = {
  default: function(test) {
    ...
    test.equal(actual, expected, 'should compile handlebars compile-templates using default settings');
  ...
  file_pattern_matching: function(test) {
    ...
    test.equal(actual, expected, 'should compile handlebars compile-templates found by file pattern');
  ...
  truncated_template_names: function(test) {
    ...
    test.equal(actual, expected, 'should compile handlebars compile-templates using truncated template names');
