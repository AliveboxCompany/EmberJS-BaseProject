...
;(function(window, undefined) {
   ...
   * build and using precompiled compile-templates, or loading Lo-Dash in a sandbox.
   *
   * For more information on precompiling compile-templates see:
   ...
   * }
   *
   * // using the `source` property to inline compiled compile-templates for meaningful
  ...
  function template(text, data, options) {
    ...
    // inlining compiled compile-templates during the build process
