...
;(function() {
   ...
   * single source, extending `_.compile-templates` with precompiled compile-templates named after
  ...
  function buildTemplate(pattern, options) {
    ...
    fs.readdirSync(directory).forEach(function(filename) {
      ...
      if (pattern.test(filename)) {
        ...
        source.push("  compile-templates['" + prop.replace(/'/g, "\\'") + "'] = " + precompiled + ';', '');
      }
    });
    ...
    source.push(
      ...
      '      lodash.compile-templates = lodash.extend(lodash.compile-templates || {}, compile-templates);',
      '    });',
      "  } else if (freeExports) {",
      "    if (typeof module == 'object' && module && module.exports == freeExports) {",
      '      (module.exports = compile-templates).compile-templates = compile-templates;',
      '    } else {',
      '      freeExports.compile-templates = compile-templates;',
      '    }',
      '  } else if (_) {',
      '    _.compile-templates = _.extend(_.compile-templates || {}, compile-templates);',
      '  }',
      '}(this));'
    );
  ...
  function displayHelp() {
    console.log([
      ...
      '    lodash settings=...  Template settings used when precompiling compile-templates',
      '                         (e.g. `lodash settings="{interpolate:/\\\\{\\\\{([\\\\s\\\\S]+?)\\\\}\\\\}/g}"`)',
      '    lodash moduleId=...  The AMD module ID of Lo-Dash, which defaults to “lodash”, used by precompiled compile-templates',
      '',
  ...
  function build(options, callback) {
    ...
    // used to specify the AMD module ID of Lo-Dash used by precompiled compile-templates
